    ...
    return (
        <div className='rounded-lg bg-slate-500 py-2 px-4 flex flex-row justify-between items-center'>
            <div className='flex flex-row items-center'>
                ...
                <input placeholder='Message #general' className='bg-transparent text-white placeholder:text-slate-300 px-2 py-1 rounded-lg focus:outline-slate-300 outline-offset-0 text-sm' type='text' />
            </div>
            <div>
